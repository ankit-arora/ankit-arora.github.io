...
wzrkPermissionPopup.wzrkCreatePopDiv = function(hidePoweredByCT) {
    ...
    if(!hidePoweredByCT){
        // alert powered by
        createDiv(undefined, msgAlert, 'wzrk-powered', '<a href="https://clevertap.com" target="_blank">Powered by <img src="https://d2r1yp2w7bby2u.cloudfront.net/js/ct_logo.svg" height="9" style="height:9px;"></a>');
    }
...
window['wzrkPermissionPopup'] = wzrkPermissionPopup;
wzrkPermissionPopup['wizAlert'] = wzrkPermissionPopup.wizAlert;